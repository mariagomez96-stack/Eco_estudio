...
def paginaprincipal_ingles():
    ...
    with col1:
        ...
        st.markdown("<br>", unsafe_allow_html=True)
        st.write("""<p style='text-align:center;font-size: 25px; color:cyan;'><strong>EcoSurvey</p>""", unsafe_allow_html=True)
        st.markdown(" ")
        st.write("""<p style='text-align:justify;font-size: 18px'>Do you want to test your level of environmental awareness? In the EcoSurvey tab, we offer you that.</p>""", unsafe_allow_html=True)
    ...
    with col3:
        ...
        st.markdown(" ")
        st.markdown(" ")
        st.write("""<p style='text-align:center;font-size: 25px; color:cyan'><strong> EcoContact </p>""", unsafe_allow_html=True)
        st.markdown(" ")
