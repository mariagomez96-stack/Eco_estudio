...
#<div style='text-align: justify; font-size: 18px;'> para los textos
#st.write("<span style='display: block; text-align: center; font-size: 50px; font-weight: bold;'>¡Bienvenidos al equipo!</span>", unsafe_allow_html=True) para titulo
#st.markdown("<span style='color: cyan; white-space: nowrap; text-align: center; font-size: 30px; font-weight: bold;'>Esto es de Ana</span>", unsafe_allow_html=True) para subtitulo
...
def EcoEstudio():
    ...
    input_usuario = st.sidebar.selectbox("", lista_opciones)
    #-----------------------------------------------------------
    ...
    if input_usuario == "Categorías de Vehiculos" :
        ...
        with col2:
            ...
            FuncionesEcoMovilidad.funcion_categorias_e_c(input_usuario_vehiculos)
        ...
        FuncionesEcoMovilidad.funcion_calsificacion_e_c('Todos')
        col1,col2 = st.columns(2)
        with col1:
        ...
        FuncionesEcoMovilidad.funcion_calsificacion_e_c(input_usuario_vehiculos)
        #----------------------------------------------------------
        ...
        FuncionesEcoMovilidad.funcion_etiqueta_g_sin_especificar()
        ...
        FuncionesEcoMovilidad.funcion_autonomia_bateria()
        ...
        with col2:
            FuncionesEcoMovilidad.funcion_violin_autonomia_conjunta_e()
        ...
        st.markdown(" ")
        st.markdown(" ")
        st.markdown("<span style='color:cyan;font-size:30px;font-weight:bold'>¿ Qué categorías hay dentro de los vehículos más populares ?</span>", unsafe_allow_html=True)
      
        FuncionesEcoMovilidad.funcion_autonomia_por_categoria_e()
        ...
        with col2:
            ...
            FuncionesEcoMovilidad.funcion_scater_potencia_autonomia_e(input_usuario_vehiculos)
        ...
        with col7:
            ...
            FuncionesEcoMovilidad.funcion_potencia_caja_e(['Eléctricos puros'])
        with col8:
            FuncionesEcoMovilidad.funcion_potencia_barras_e(['Eléctricos puros'])
        ...
        with col2:
            ...
            st.markdown(" ")
            st.markdown(" ")
            FuncionesEcoMovilidad.funcion_potencia_barras_e(input_usuario_vehiculos)
        with col1:
        
            FuncionesEcoMovilidad.funcion_potencia_caja_e(input_usuario_vehiculos)
            texto = """
                        <div style='text-align: justify; font-size: 18px;'>
        ...
        FuncionesEcoMovilidad.funcion_proporcion_motorizacion()
...
Aunque el gas natural puede ser más eficiente en términos de combustión, tiene un contenido energético más bajo por unidad de volumen en comparación con la gasolina o el diésel. Esto significa que los vehículos de gas natural pueden necesitar tanques más grandes o más frecuentes llenados de combustible para obtener la misma autonomía que un vehículo de gasolina o diésel.\n</div>"""
        ...
        with col1:
            ...
            FuncionesEcoMovilidad.funcion_boxplot_motorizacion_usuario(opcion_seleccionada)
        ...
        with col2:
            FuncionesEcoMovilidad.funcion_quesito_emisiones()
        ...
        FuncionesEcoMovilidad.funcion_emisiones_consumo("Todos")
