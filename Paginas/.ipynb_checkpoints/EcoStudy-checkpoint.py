...
from funciones import FuncionesEcoMovilidadIngles
...
def EcoStudy():
    ...
    user_input = st.sidebar.selectbox("", options_list)
    #-----------------------------------------------------------
    ...
    if user_input == "Vehicle Categories":
        ...
        with col2:
            ...
            FuncionesEcoMovilidadIngles.funcion_categorias_e_c(user_vehicle_input)
        ...
        FuncionesEcoMovilidadIngles.funcion_calsificacion_e_c('All')
        col1,col2 = st.columns(2)
        with col1:
        ...
        FuncionesEcoMovilidadIngles.funcion_calsificacion_e_c(user_input_vehicles)
        #----------------------------------------------------------
        st.write("<span style='display: block; text-align: center; font-size: 50px; font-weight: bold;'>What happens with vehicles labeled G and Not Specified?</span>", unsafe_allow_html=True)
        
        #Author's notes: Here I won't make it selectable initially because it's interesting to see all at once rather than one by one
        FuncionesEcoMovilidadIngles.funcion_etiqueta_g_sin_especificar()
        ...
        FuncionesEcoMovilidadIngles.funcion_autonomia_bateria()
        ...
        with col2:
            FuncionesEcoMovilidadIngles.funcion_violin_autonomia_conjunta_e()
        ...
        st.markdown(" ")
        st.markdown(" ")
        st.markdown("<span  style='color:cyan;font-size:30px;font-weight:bold'>What categories are within the most popular vehicles?</span>", unsafe_allow_html=True)
    
        FuncionesEcoMovilidadIngles.funcion_autonomia_por_categoria_e()
        ...
        with col2:
            ...
            FuncionesEcoMovilidadIngles.funcion_scater_potencia_autonomia_e(input_usuario_vehiculos)
        ...
        with col7:
            ...
            FuncionesEcoMovilidadIngles.funcion_potencia_caja_e(['Pure Electric'])
        with col8:
            FuncionesEcoMovilidadIngles.funcion_potencia_barras_e(['Pure Electric'])
        ...
        with col2:
            ...
            st.markdown(" ")
            st.markdown(" ")
            FuncionesEcoMovilidadIngles.funcion_potencia_barras_e(input_usuario_vehiculos)
        with col1:

            FuncionesEcoMovilidadIngles.funcion_potencia_caja_e(input_usuario_vehiculos)
            texto = """
                        <div style='text-align: justify; font-size: 18px;'>
    ...
    # ------------------------------------'Vehicles Distribution and their Consumption'------------------------------------
        ...
        FuncionesEcoMovilidadIngles.funcion_proporcion_motorizacion()
    ...
    Although natural gas may be more efficient in terms of combustion, it has a lower energy content per unit volume compared to gasoline or diesel. This means that natural gas vehicles may require larger or more frequent fuel tanks to achieve the same range as a gasoline or diesel vehicle.\n</div>"""
        ...
        with col1:
            ...
            FuncionesEcoMovilidadIngles.funcion_boxplot_motorizacion_usuario(selected_option)


        col1, col2 = st.columns([0.9, 1])

        with col2:
            FuncionesEcoMovilidadIngles.funcion_quesito_emisiones()
        ...
        FuncionesEcoMovilidadIngles.funcion_emisiones_consumo("All")
