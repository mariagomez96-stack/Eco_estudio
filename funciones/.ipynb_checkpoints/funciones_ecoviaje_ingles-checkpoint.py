...
def funcion_comparacion_seleccion_usario_modelo(columnas, lista_titulos, seleccionElectrico= None,seleccionGasoi=None,seleccionGasolina=None ,seleccionHibrido=None):
    ...
    if seleccionElectrico and seleccionHibrido and columnas == 2:
        ...
        fig.add_trace(
            go.Bar(x=df_hibrido["Model"], 
                    y=df_hibrido['Minimum Consumption (l/100km)'],
                    marker_color="green",
                    name="Fuel Consumption (l/100km) min"), 
            row=1, col=lista_columnas[1]
        )

        fig.add_trace(
            go.Bar(x=df_hibrido["Model"], 
                    y=df_hibrido['Maximum Consumption (l/100km)'],
                    marker_color="purple",
                    name="Fuel Consumption (l/100km) max"), 
            row=1, col=lista_columnas[1]
        )
    ...
    if seleccionGasoi and seleccionGasolina and columnas == 2:
        ...
        fig.add_trace(
            go.Bar(x=df_gasoi["Model"], 
                y=df_gasoi['Minimum Consumption (l/100km)'],
                marker_color="green",
                showlegend=False), 
            row=1, col=lista_columnas[0]
        )
        ...
        fig.add_trace(
            go.Bar(x=df_gasoi["Model"], 
                y=df_gasoi['Maximum Consumption (l/100km)'],
                marker_color="purple",
                showlegend=False), 
            row=1, col=lista_columnas[0]
        )
        ...
        fig.add_trace(
            go.Bar(x=df_gasolina["Model"], 
                y=df_gasolina['Minimum Consumption (l/100km)'],
                marker_color="green",
                showlegend=False), 
            row=1, col=lista_columnas[1]
        )
        ...
        fig.add_trace(
            go.Bar(x=df_gasolina["Model"], 
                y=df_gasolina['Maximum Consumption (l/100km)'],
                marker_color="purple",
                showlegend=False), 
            row=1, col=lista_columnas[1]
        )
